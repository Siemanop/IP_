...
<body>
    <nav class="navbar navbar-expand-lg fixed-top" style="background-color: #fe965a;">
        <div class="container">
            <a class="navbar-brand text-light" href="#">ระบบลงทะเบียนเรียน</a>
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item <?=$active_admin?>">
                        <a class="nav-link text-light" href="login-page.php">ภาพรวมข้อมูล</a>
                    </li>
                    <li class="nav-item <?=$active_admin?>">
                    ...
                    <li class="nav-item <?=$active_admin?>">
                        <a class="nav-link text-light" href="login-page.php">Log out</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row justify-content-md-center">
            ...
            WHERE user_id = $id";
                ...
                <form action="stu_edit.php" method="post">
                    ...
                    <input type="text" name="fname" value="<?php echo $result["stu_fname"]; ?>">

                    <label style="color: #fe965a;">นามสกุล</label>
                    <input type="text" name="lname" value="<?php echo $result["stu_lname"]; ?>">
                    ...
                    <input type="date" name="birth" value="<?php echo $result["stu_birth"]; ?>">
                    ...
                    <input type="number" name="phone" value="<?php echo $result["stu_phone"]; ?>">

                    <label style="color: #fe965a;">อีเมล</label>
                    <input type="email" name="email" value="<?php echo $result["stu_email"]; ?>">
                    <br>
                    <br>
                    <label style="color: #fe965a;">ที่อยู่</label>
                    <input type="textfield" name="address" value="<?php echo $result["stu_address"]; ?>">
                    <br>
                    <br>

                    <a href="show_stu.php" class="btn btn-success" type="submit">Submit</a>
