...
<body>
    ...
    <div class="container py-5">
        ...
        <div class="col-md-auto">
            <h1 class="text-center" style="color: #fe965a;">แก้ไขข้อมูลอาจารย์</h1><br>
        </div>
        <div class="row justify-content-md-center">
            ...
            WHERE user_id = $id";
                ...
                <form action="" method="post">
                    ...
                    <a href="show_emp.php" class="btn btn-success" type="submit">Submit</a>
                    <a href="show_emp.php" class="btn btn-danger">Cancel</a>
                </form>
