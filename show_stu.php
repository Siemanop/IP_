        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="JavaScript:if(confirm('Confirm Edit?')==true){window.location='stu_editForm.php?userID=<?php echo $row['user_id'];?>';} "class="btn btn-success">Edit</a></td>
                    <td ><a href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='delete_stu.php?userID=<?php echo $row['user_id']; ?>';}" class="btn btn-danger">ลบ</a></td>
